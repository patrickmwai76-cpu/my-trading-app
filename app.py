...
if s1 and s2: st.sidebar.success("✅ READY")
...
if not df.empty:
    ...
    # --- TRIPLE SUBPLOTS (Price, RSI, Volume) ---
    fig = make_subplots(
        rows=3, cols=1, 
        shared_xaxes=True, 
    ...
    fig.update_layout(template="plotly_dark", height=1000, xaxis_rangeslider_visible=False, margin=dict(l=10, r=10, t=0, b=0), showlegend=False)

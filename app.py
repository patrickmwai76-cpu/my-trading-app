...
# 1. 4K/3D UI STYLING (The "Glass" Look)
...
{ "interval": "15m", "width": "100%", "height": "380", "isTransparent": true, "symbol": "%s", "showIntervalTabs": true, "displayMode": "single", "colorTheme": "dark" }
</script></div>
"""
with col_g: components.html(gauge_code % "OANDA:XAUUSD", height=390)
with col_d: components.html(gauge_code % "TVC:DXY", height=390)

# 4. THE "4K" SMC SIGNAL CHART (Signals on Chart)
